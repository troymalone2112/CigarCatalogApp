...
async function checkAllSubscriptions() {
  try {
    ...
    allSubscriptions.forEach((sub, index) => {
      ...
      console.log(
        `   Trial Start: ${sub.trial_start_date ? new Date(sub.trial_start_date).toLocaleString() : 'N/A'}`,
      );
      console.log(
        `   Trial End: ${sub.trial_end_date ? new Date(sub.trial_end_date).toLocaleString() : 'N/A'}`,
      );
