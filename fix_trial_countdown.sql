-- Fix trial countdown calculation to be accurate and consistent
-- This updates the get_user_subscription_status function to properly calculate days remaining
...
-- Update the update_subscription_from_revenuecat function to preserve trial dates
