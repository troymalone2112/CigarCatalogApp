...
function extractFlavorTags(description) {
    ...
    const commonFlavors = [
        'chocolate', 'coffee', 'leather', 'cedar', 'earth', 'spice', 'pepper',
        'nuts', 'cream', 'vanilla', 'caramel', 'honey', 'sweetness', 'tobacco',
        'wood', 'smoke', 'cocoa', 'espresso', 'dark chocolate', 'roasted',
        'nutty', 'earthy', 'spicy', 'sweet', 'creamy', 'woody', 'smoky',
        'toasty', 'rich', 'smooth', 'bold', 'complex', 'balanced', 'elegant'
    ];
...
async function migrateCigarData() {
    try {
        ...
        // Read CSV file
        const csvPath = path.join(__dirname, 'assets', 'complete_top25_cigars_2024_2023_2022 - complete_top25_cigars_2024_2023_2022.csv');
        ...
        for (const line of dataLines) {
            try {
                ...
                successCount++;
                console.log(`✅ Migrated: ${brandName} ${cigarName} (Rating: ${rating}, Year: ${year || 'Unknown'})`);
